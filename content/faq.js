...
`,
  ...
  'en-UK': {
    ...
    questions: [
      ...
      {
        question: 'How to get into contact with the people driving the project?',
        answer: `**Primary** Martin Permin [+1 (323) 529-7523](tel:+13235297523) / [martin@pelion.app](mailto:martin@pelion.app)

**Tech** Holger Thorup [+45 60 55 07 09](tel:+4560550709) / [holger@pelion.app](mailto:holger@pelion.app])

**Communication** Carl Kronika [+45 20 87 28 89](tel:+4520872789) / [ck@copus.dk](mailto:ck@copus.dk)
`,
      },
      {
        question: 'Why c19.dk?',
        answer:
          'The "Flatten the curve" strategy means that we have little information about the number of Danes with symptoms who are not in contact with the health services. This tool reveals the number of unreported cases, to help the authorities predict the pressure on hospitals.',
      },

      {
        question: 'How do I withdraw my consent?',
        answer:
          'You can always withdraw your consent and have your data be deleted and forgotten by contacting our Data Protection Officer Holger Thorup på [+45 60 55 07 09](tel:+4560550709) / [holger@pelion.app](mailto:holger@pelion.app]).',
      },
      {
        question: 'How is my data processed and used?',
        answer:
          'Your data is processed in accordance with GDPR regulation and are not shared with anyone, except by aggregation that protects your privacy. Read more on how your data is being processed in our [privacy policy](/privacy).',
      },
      {
